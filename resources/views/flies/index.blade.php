...
<div class="mt-5">
    ...
    <div class="flex justify-end mb-4 mr-6 ml-6 px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto px-6">
       @if ($flies->count() > 0)
            @foreach ($flies as $fly)
                <div class="p-6 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                    ...
                    <p class="mb-5 text-sm sm:text-base font-normal text-gray-700 dark:text-gray-400 min-h-[70px]">
                        Aqui vai uma descrição ou introdução breve da fly. Você pode substituir por conteúdo real.
                    </p>
                    <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition">
                        Ver mais
